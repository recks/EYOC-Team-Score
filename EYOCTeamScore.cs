...
<body>
<h1 class='o-h1'>EYOC Team Score - individual</h1>
");
            foreach (Event evt in ActiveEvents)
            {
...
<body>
<h1 class='o-h1'>EYOC Team Score - total</h1>
...
");
            ...
            report.AppendLine("<table class='o-table'><tr class='o-tr'><th class='o-th'>Country</th><th class='o-th'>Points</th></tr>");
            ...
            {
                report.AppendLine($"<tr class='o-tr'><td class='o-td'>{country.Key}</td><td class='o-td'>{country.Value}</td></tr>");
            }
            report.AppendLine("</table>");
            report.AppendLine("</body></html>");
